...
export const IMAGE_GEN_ENV_KEYS = {
  providerId: 'UBIDBUDDY_IMG_PROVIDER_ID',
  platform: 'UBIDBUDDY_IMG_PLATFORM',
  baseUrl: 'UBIDBUDDY_IMG_BASE_URL',
  apiKey: 'UBIDBUDDY_IMG_API_KEY',
  model: 'UBIDBUDDY_IMG_MODEL',
} as const;
