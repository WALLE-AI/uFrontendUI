...
export type BackendStartupFailureReason =
  ...
  // The local database was created by a newer uBidBuddy version (downgrade).
  // The data is intact; the fix is updating uBidBuddy, not reinstalling or
...
export interface BackendStartupFailureInfo {
  ...
  /** Currently installed uBidBuddy version, stamped by the main process when a
