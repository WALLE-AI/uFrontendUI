...
// This standalone build has no login page and assumes the backend requires no
// auth session — always treat the app as authenticated, the same way the
// original desktop (Electron) runtime always did.
