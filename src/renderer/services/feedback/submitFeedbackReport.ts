...
export async function submitFeedbackReport(input: SubmitFeedbackReportInput): Promise<void> {
  ...
  try {
    ...
    // Sentry-based feedback submission is Electron-only (@sentry/electron is not
    // installed in this standalone build). Route feedback to your own backend
    // instead, or remove this feature from the UI.
