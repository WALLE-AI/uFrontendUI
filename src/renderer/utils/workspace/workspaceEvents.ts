export const WORKSPACE_TOGGLE_EVENT = 'ubidbuddy-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'ubidbuddy-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'ubidbuddy-workspace-has-files';
